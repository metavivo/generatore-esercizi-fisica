...
function generateProblem() {
  problem = {
    text: "Un corpo di massa $m = 4$ kg, inizialmente fermo ($v_i = 0$ m/s), viene spinto da una forza che compie un lavoro di $L = 80$ J. Qual è la sua velocità finale ($v_f$)?",
    formalizeData: "Dati:\n- Massa: $m = 4$ kg\n- Velocità iniziale: $v_i = 0$ m/s\n- Lavoro compiuto: $L = 80$ J",
    get formalizeDataFormatted() {
      return this.formalizeData.replace(/\n- /g, '<br>- ');
    },
    equations: "Equazioni risolutive:\n1. Teorema dell'energia cinetica: $L = \\Delta K = K_f - K_i$\n2. Energia cinetica: $K = \\frac{1}{2} m v_f^2$",
    ...
    finalCalculationPrompt: "Calcolo numerico:\n$v_f = \\sqrt{\\frac{2 \\cdot 80 \\text{ J}}{4 \\text{ kg}}} = \\sqrt{40} \\text{ m/s} \\approx 6.32 \\text{ m/s}$",
    correctAnswers: ["kg", "L = \\Delta K = K_f - K_i", "Velocità finale (vf)", "vf = \\sqrt{\\frac{2L}{m}}", "\\sqrt{40} \\text{ m/s}", "6.32 \\text{ m/s}"]
  };
  step = 0;
  feedback = "";
  console.log("Oggetto problem generato in setup:", problem);
