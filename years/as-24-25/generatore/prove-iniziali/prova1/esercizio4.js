...
function generateProblem() {
  problem = {
    text: "Un corpo di massa $m = 6$ kg, inizialmente fermo, viene spinto da una forza che compie un lavoro di $L = 72$ J. Qual è la sua velocità finale $v_f$?",
    formalizeData: "Dati:\n- Massa: $m = 6$ kg\n- Velocità iniziale: $v_i = 0$ m/s\n- Lavoro compiuto: $L = 72$ J",
    ...
    literalSolution: "$L = \\frac{1}{2} m v_f^2 - \\frac{1}{2} m v_i^2$\nDato che $v_i = 0$:\n$L = \\frac{1}{2} m v_f^2$\n$\\implies 2L = m v_f^2$\n$\\implies v_f^2 = \\frac{2L}{m}$\n$\\implies v_f = \\sqrt{\\frac{2L}{m}}$",
    get literalSolutionFormatted() {
      return this.literalSolution.split('\n').join("<br>");
    },
    finalCalculationPrompt: "Calcolo numerico:<br>$v_f = \\sqrt{\\frac{2 \\cdot 72 \\text{ J}}{6 \\text{ kg}}}$<br>$= \\sqrt{\\frac{144}{6}} \\text{ m/s}$<br>$= \\sqrt{24} \\text{ m/s}$<br>$\\approx 4.90 \\text{ m/s}$",
    correctAnswers: ["kg", "L = \\Delta K = K_f - K_i", "Velocità finale (vf)", "vf = \\sqrt{\\frac{2L}{m}}", "\\approx 4.90 \\text{ m/s}", "4.90 m/s"],
  };
  step = 0;
  feedback = "";
  console.log("Oggetto problem generato in setup:", problem);
